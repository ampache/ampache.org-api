...
| 'include' | string | 'albums', 'songs' will include the JSON nested in the artist JSON |      YES |
...
| 'offset'  | integer    |                                                                                |      YES |
| 'limit'   | integer    |                                                                                |      YES |
| 'include' | string     | 'albums', 'songs' will include the corresponding JSON nested in the album JSON |      YES |
