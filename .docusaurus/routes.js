...
export default [
  {
    path: '/api/',
    component: ComponentCreator('/api/', '92e'),
    routes: [
      {
        path: '/api/',
        component: ComponentCreator('/api/', 'ad7'),
        routes: [
          {
            path: '/api/',
            component: ComponentCreator('/api/', 'c83'),
            routes: [
              {
              ...
              },
              {
                ...
                component: ComponentCreator('/api/versions/api-4.1/api-errors', '2d3'),
                exact: true
              },
              {
